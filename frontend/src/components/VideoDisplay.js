...
// CRA envs
const MODE  = (process.env.REACT_APP_VIDEO_MODE || "snapshot").toLowerCase();
...
export default function VideoDisplay() {
  ...
  //   setErr(
  //     MODE === "mjpeg"
  //       ? "Stream unavailable. Check REACT_APP_MJPEG_URL or use snapshot mode."
  //       : MODE === "annotated"
  //       ? "No annotated frame. Ensure backend /api/video/latest is working."
  //       : "Snapshot failed. Check REACT_APP_SNAPSHOT_URL."
  //   );
  // };
  const ERROR_BY_MODE = {
